...
def data_export_api_time(nombre_archivo='datos_exportados_tiempo.json'):
    api =f'http://192.168.0.200//api/chart/{num_phase}/{allow_parameters[2]}/from/{fecha_1.year}-{fecha_1.month}-{fecha_1.day}T{hora_1}.000Z/to/{fecha_2.year}-{fecha_2.month}-{fecha_2.day}T{hora_2}.000Z'
    try:
